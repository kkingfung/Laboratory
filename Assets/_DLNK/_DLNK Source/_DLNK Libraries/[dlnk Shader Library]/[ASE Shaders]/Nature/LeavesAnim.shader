...
Shader "DLNK Shaders/ASE/Nature/LeavesAnim"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			float4 appendResult64 = (float4(( simplePerlin3D57 * lerpResult83 ) , 0.0 , ( simplePerlin3D57 * lerpResult85 ) , 0.0));
			float4 transform62 = mul(unity_WorldToObject,appendResult64);
			float temp_output_7_0_g1 = _LeavesGradientxy.x;
			float temp_output_69_0 = ( ( v.texcoord.xy.y - temp_output_7_0_g1 ) / ( _LeavesGradientxy.y - temp_output_7_0_g1 ) );
			v.vertex.xyz += ( transform62 * temp_output_69_0 ).xyz;
			v.vertex.w = 1;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_7_0_g1 = _LeavesGradientxy.x;
			float temp_output_69_0 = ( ( i.uv_texcoord.y - temp_output_7_0_g1 ) / ( _LeavesGradientxy.y - temp_output_7_0_g1 ) );
			float4 lerpResult49 = lerp( _ColorA , _ColorB , temp_output_69_0);
...
Node;AmplifyShaderEditor.WorldToObjectTransfNode;62;6.839677,305.6927;Inherit;False;1;0;FLOAT4;0,0,0,1;False;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.FunctionNode;69;-769.4716,-62.42495;Inherit;False;Remap To 0-1;-1;;1;e6e209ac370e7e74da13a6a97e315390;0;3;6;FLOAT;0;False;7;FLOAT;0;False;8;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;80;235.3964,306.371;Inherit;False;2;2;0;FLOAT4;0,0,0,0;False;1;FLOAT;0;False;1;FLOAT4;0
Node;AmplifyShaderEditor.PannerNode;56;-674.548,695.5698;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;60;-855.3953,838.7082;Inherit;False;Property;_NoiseScale;Noise Scale;8;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.NoiseGeneratorNode;57;-561.0234,552.0229;Inherit;False;Simplex3D;True;False;2;0;FLOAT3;0,0,0;False;1;FLOAT;1;False;1;FLOAT;0
...
WireConnection;69;6;68;2
WireConnection;69;7;73;1
WireConnection;69;8;73;2
...
ASEEND*/
//CHKSM=670003728C4C1E69AA866F31F89AEA6174E7E2D3