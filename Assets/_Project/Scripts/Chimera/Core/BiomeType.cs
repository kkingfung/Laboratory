...
{
    /// <summary>
    /// Unified BiomeType enumeration for the entire Chimera ecosystem system.
    /// Defines different environmental zones where creatures can live, breed, and evolve.
    /// Each biome affects creature spawning, genetic adaptation, and environmental pressures.
    /// </summary>
