...
namespace Laboratory.Subsystems.Performance
{
    ...
    public class PerformanceSubsystemConfig : ScriptableObject
    {
        ...
        /// </summary>
        public bool ShouldTriggerAlert(PerformanceAlertType alertType, float currentValue, float budgetValue)
        {
            ...
            {
                PerformanceAlertType.LowFrameRate => lowFrameRateAlertThreshold,
                PerformanceAlertType.HighMemoryUsage => highMemoryAlertThreshold,
                PerformanceAlertType.HighDrawCalls => highDrawCallAlertThreshold,
                _ => 0.8f
            };
