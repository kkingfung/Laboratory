    ...
    public class NPCManager : MonoBehaviour
    {
        ...
        public void OnNPCAttacked(NPCBehavior attackedNPC, Transform attacker)
        {
            ...
            foreach (var witness in witnesses)
            {
                ...
                {
                    witness.OnAttacked(attacker.gameObject); // Make witness flee
                }
                else if (reactionRoll < groupFleeChance + groupPanicChance)
                {
                    // Make witness panic without being directly attacked
                    witness.ReactToWitnessedViolence(attacker.gameObject);
                }
            }
        ...
        public float GetOverallReputation()
        {
            ...
            return npcCount > 0 ? totalReputation / npcCount : 0f;
        }
