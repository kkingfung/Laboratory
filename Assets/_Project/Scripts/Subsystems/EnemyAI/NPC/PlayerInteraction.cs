...
namespace Laboratory.Core.NPC
{
    ...
    public class PlayerInteraction : MonoBehaviour
    {
        ...
        {
            // Interact
            if (UnityEngine.Input.GetKeyDown(interactionKey) && nearestNPC != null)
            {
                nearestNPC.StartConversation(gameObject);
            }
            ...
            // Help
            if (UnityEngine.Input.GetKeyDown(helpKey))
            {
                Help();
            }
            
            // Complete quest (when carrying quest item)
            if (UnityEngine.Input.GetKeyDown(questCompleteKey))
            {
                CompleteQuest();
            }
        }
        ...
        public void Help()
        {
            if (nearestNPC != null)
            {
                nearestNPC.OnHelped(gameObject);
            }
        }
